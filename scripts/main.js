const translations = {
  ru: {
    ...
    'hero.tagline': 'Система SABSUS из будущего',
    ...
    'vision.body': 'SABSUS объединяет визуальные слои, память и эмоциональную логику, чтобы показать, как будет ощущаться интерфейс будущего. Без серверов и подписок — только чистое взаимодействие.',
    ...
    'vision.card3.body': 'Градиенты, стеклянные панели и неоновые блики формируют узнаваемый язык продукта SABSUS.',
    ...
    'final.title': 'Готовы увидеть SABSUS в действии?',
    'final.body': 'Перенеситесь в будущее: активируйте автономный режим AKSI и почувствуйте, как система реагирует на каждое движение.',
    'final.cta': 'Запустить свою систему',
    'footer': 'AKSI SABSUS © 2046 — будущее развёрнуто сегодня.'
  },
  en: {
    'nav.vision': 'Vision',
    'nav.capabilities': 'Capabilities',
    'nav.timeline': 'Launch Path',
    'hero.tagline': 'SABSUS system from the future',
    ...
    'vision.body': 'SABSUS fuses visual layers, memory and emotional logic to show how interfaces of tomorrow will feel. No servers or subscriptions — just pure interaction.',
    ...
    'vision.card3.body': 'Gradients, glass panels and neon glow define the signature language of the SABSUS product.',
    ...
    'final.title': 'Ready to witness SABSUS in motion?',
    'final.body': 'Step into the future: activate AKSI’s autonomous mode and feel the system answer every gesture.',
    'final.cta': 'Launch your system',
    'footer': 'AKSI SABSUS © 2046 — the future unfolds today.'
  }
};
